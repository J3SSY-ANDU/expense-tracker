 ...
 *
 * Generates a unique verification token, constructs a verification URL,
 * and sends an email containing the verification link to the user.
 * The verification link expires in half an hour.
 *
 * @async
 * @function
 ...
 *
 * This function generates a password reset token, constructs a reset URL,
 * and sends an email with the reset link to the user. The reset link expires in 30 minutes.
 *
 * @async
 * @param {string} email - The email address of the user requesting a password reset.
 * @throws {Error} Throws an error if the token is not found or if sending the email fails.
...
/**
 * Sends an account deletion confirmation email to the specified user.
 *
 * @async
 * @function
 * @param {string} name - The name of the user whose account was deleted.
 * @param {string} email - The email address of the user to send the confirmation to.
